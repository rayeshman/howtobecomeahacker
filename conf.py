...
BLOG_AUTHOR = "Hossein"
BLOG_TITLE = "How to become a hacker?"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://howtobecomeahacker.github.io/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nikola.ralsina.com.ar"
BLOG_EMAIL = "rayeshman@riseup.net"
BLOG_DESCRIPTION = "How To Become A Hacker Eric S. Raymond"
...
# Default is ''
CONTENT_FOOTER = 'Written By: Eric S. Raymond,Translate:Arash Bijanzade With Navid Abdi & Alan Baqumian\'s help (Update to Revision 1.45 and some other edits by <a href="mailto:rayeshman@riseup.net">rayeshman</a>) - Powered by <a href="http://nikola.ralsina.com.ar">Nikola</a> {date}'
